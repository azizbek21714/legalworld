        ...
        <div class="container">
          <div class="row row-50 justify-content-center justify-content-lg-between">
            <div class="col-md-10 col-lg-6">
              ...
              <ul>
                <li>•	5555555555555 asdasdas asd asdКонсультирование в проведении тендерных и конкурсных торгов для предприятий любых форм собственности и сферы деятельности;</li>
